...
# Council — five thinking-lens advisors, anonymised peer review, forced debate
# when consensus looks too clean, and a dual-chairman synthesis that preserves
# dissent. Triggered by Claude on a genuine fork ("pressure-test this", "torn
# between two options") or invoked by name. Needs `jq` on PATH for the journal.

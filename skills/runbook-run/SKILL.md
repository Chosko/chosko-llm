...
> absolute home path — `./references/<file>.md` from this body, and
> `../runbook-run/references/<file>.md` (or `../skills/runbook-run/…` from a
> command) from elsewhere. That is scope-proof by construction.
